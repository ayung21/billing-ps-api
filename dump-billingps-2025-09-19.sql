...
INSERT INTO `history_produk` VALUES (1,NULL,1,'mie goreng',12,1000,4000,'2025-09-19 08:46:30',1),(2,NULL,1,'mie goreng indomie',12,1000,4000,'2025-09-19 08:47:06',1),(3,NULL,1,'mie goreng indomie',5,1000,4000,'2025-09-19 08:47:43',1),(4,1,1,'mie goreng indomie',5,1000,4000,'2025-09-19 08:48:12',1);
...
INSERT INTO `produk` VALUES (1,1,5,'mie goreng indomie',1000,4000,1,1,'2025-09-18 16:26:09',1,'2025-09-19 08:47:43',1);
...
INSERT INTO `promo` VALUES (1,2,10,NULL,3,1,'2025-09-18 15:20:15',1,'2025-09-18 15:21:17',1,'weekend');
...
INSERT INTO `units` VALUES (1,'ps 5 nomer 4',NULL,1,0,'2025-09-18 13:34:36',1,'2025-09-18 14:30:19',1),(2,'ps 5 nomer 3',NULL,1,1,'2025-09-18 14:30:00',1,'2025-09-18 14:30:00',1);
...
CREATE TABLE `users` (
  ...
  `status` int DEFAULT NULL COMMENT '0. non - active\n1. active',
  `activ_period` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'ayungyung20@gmail.com','ayung','$2b$10$eBF.vSnoNNk3oC7pRRcMDumtMovcdnCJ3TJKzfqqWE9fZI7jA55ra',1,'2025-09-18 09:11:06');
...
-- Dump completed on 2025-09-19 14:57:03
